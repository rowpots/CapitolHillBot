...
* `TRADE_PRIME_TIME_SEND_HOUR_ET=16` holds overnight and morning trades until 4:00 PM Eastern
* `TRADE_SEND_DELAY_MINUTES=5` makes every trade — even one accepted after prime time — wait five minutes before posting (your `!veto` window in the review chat)
